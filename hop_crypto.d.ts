...
export function verify_coherence(pubkey_bytes: Uint8Array, msg: string, sig_bytes: Uint8Array): boolean;
...
export interface InitOutput {
    ...
    readonly sovereignkeypair_new: () => number;
    readonly sovereignkeypair_sign_intent: (a: number, b: number, c: number) => [number, number];
    readonly verify_coherence: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
